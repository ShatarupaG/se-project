...
document.addEventListener('DOMContentLoaded', async function () {
    ...
    async function fetchQuestion() {
        try {
            const response = await fetch(`http://34.125.80.10:3000/question?questionNumber=${questionNumber}`);
    ...
    saveButton.addEventListener('click', async function (event) {
        ...
        try {
            const response = await fetch('http://34.125.80.10:3000/saveResponse', {
                method: 'POST',
                headers: {
